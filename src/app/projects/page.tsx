...
export default function ProjectsPage() {
  ...
  return (
    <main className="flex flex-col items-center justify-start p-2 sm:p-6 mt-2 sm:mt-10">
      <h1 className={`text-2xl sm:text-3xl font-bold mb-4 ${merriweather.className}`}>
        Projects
      </h1>
      ...
      {projectsData.map((category) => (
        <section key={category.category} className="w-full max-w-6xl mb-16">
          <h2 className="text-xl sm:text-2xl font-bold mb-6">{category.category}</h2>
