...
export default function ResumePage() {
  return (
    <main className="flex flex-col items-center justify-start p-6 mt-10">
      ...
      <article className="flex flex-col items-center justify-start w-full max-w-4xl border-2 border-white p-8 rounded-lg shadow-md bg-slate-900 bg-opacity-50">
        <div className="max-w-4xl w-full">
          <section className="mb-8">
            ...
            <p className="mt-2">
              ...
              React, GraphQL, Typescript, Node.js, and more. I bring a broad
          ...
          <section className="mb-8">
            ...
            <div className="mt-4">
              ...
              <ul className="list-disc list-inside">
                <li>
                  Created, marketed, and sold prefab assets on online
                  marketplaces aimed at the social VR platform VRChat.
                </li>
                <li>
            ...
            <div className="mt-4">
              ...
              <ul className="list-disc list-inside">
                <li>
                  Developed frontend features with React, GraphQL, and
                  Typescript.
                </li>
                <li>
                  Worked with teams to integrate components smoothly into
                  existing systems.
                </li>
                <li>
            ...
            <div className="mt-4">
              ...
              <ul className="list-disc list-inside">
                ...
                <li>
                  Maintained comprehensive documentation and facilitated
